...
<form action="<?php $_SERVER["PHP_SELF"]?>" method="post">
    ...
    <input type="email" name="name_email" id="id_email" placeholder="email">
    <input type="text" name="name_nombre" id="id_nombre" placeholder="nombre de usuario">
    <input type="text" name="name_apellidos" id="id_apellidos" placeholder="apellidos">

    <input type="text" name="name_telefono" id="id_telefono" placeholder="telefono">
    <input type="text" name="name_direccion" id="id_direccion" placeholder="direccion">

...
<form action="<?php $_SERVER["PHP_SELF"]?>" method="post">
    ...
    <input type="hidden" name="name_imagen_url" id="img_url" value="0ede0a7d6e1d91b0cb18c4e32fb0c2ad.jpg">
